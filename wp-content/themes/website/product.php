            ...
            <div class="page__container">
                <nav class="breadcrumbs">
                    <ul class="breadcrumbs-list">
                        ...
                        <li class="breadcrumbs-item"><a href="/catalog/education" class="breadcrumbs-link">Образование/</a></li>
                        <li class="breadcrumbs-item"><a href="/catalog/education/mobile-panels" class="breadcrumbs-link">Мобильные интерактивные панели / </a></li>
                ...
                <div class="product-top">
                                ...
                                <div class="swiper-container product-slider__thumbs">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                                <img loading="lazy" src="img/products/02.png" alt="Thumbnail 2" class="product-slider__thumb">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                                <img loading="lazy" src="img/products/03.png" alt="Thumbnail 3" class="product-slider__thumb">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                                <img loading="lazy" src="img/products/07.png" alt="Thumbnail 1" class="product-slider__thumb">
                                                <img loading="lazy" class="play" src="img/icons/play.svg" alt="play">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                                <img loading="lazy" src="img/products/04.png" alt="Thumbnail 4" class="product-slider__thumb">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                                <img loading="lazy" src="img/products/01.png" alt="Thumbnail 1" class="product-slider__thumb">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="thumb-img">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/02.png">
                                            <img loading="lazy" class="product-img" src="img/products/02.png" alt="Product 1">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/03.png">
                                            <img loading="lazy" class="product-img" src="img/products/03.png" alt="Product 1">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/07.mp4">
                                            <img loading="lazy" class="product-img" src="img/products/07.png" alt="Product 1">
                                            <img loading="lazy" class="play" src="img/icons/play.svg" alt="play">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/04.png">
                                            <img loading="lazy" class="product-img" src="img/products/04.png" alt="Product 1">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/01.png">
                                            <img loading="lazy" class="product-img" src="img/products/01.png" alt="Product 1">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/02.png">
                                    ...
                                    <div class="swiper-slide">
                                        <a data-fslightbox="product" href="img/products/05.png">
                                            <img loading="lazy" class="product-img" src="img/products/05.png" alt="Product 1">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="product-main-info">
                        ...
                        <div class="product-main-info__text">
                            Мобильная интерактивная панель — это не просто устройство, это ваше персональное окно в мир возможностей. 
                            <br><br>
                            Мобильная панель MOBISCREEN является уникальным сочетанием передового дизайна и инновационных технологий.
                            Ее подвижная конструкция позволяет легко интегрировать устройство в любое пространство, будь то гостиная,
                            спальня или открытое пространство. Этот сенсорный экран объединяет функциональность планшетного ПК и телевизора,
                            обеспечивая максимальную портативность и удобство использования.
                            <br><br>
                            Совместимость с приложениями Android делает ее идеальным компаньоном для развлечений, работы и обучения.
                        </div>
                ...
                <div class="product-page-form">
                    ...
                    <div class="product-page-form__content form-wrapper">
