            ...
            <div class="projects-page__container">
                <nav class="breadcrumbs">
                    <ul class="breadcrumbs-list">
                        ...
                        <li class="breadcrumbs-item breadcrumbs-current">Все проекты</li>
                    </ul>
                </nav>
                ...
                <div class="project-items">
                    <a href="/project.php" class="project-item ibg">
                        <img loading="lazy" class="project-img" src="img/fabric-video/01.png" alt="projects-item-img">
                    ...
                    <a href="/project.php" class="project-item ibg">
                        <img loading="lazy" class="project-img" src="img/fabric-video/01.png" alt="projects-item-img">
                        <div class="project-title">
                            Проект 2 название с длинным текстом и не помещается в 1 строку
                        </div>
                    </a>
                    <a href="/project.php" class="project-item ibg">
                        <img loading="lazy" class="project-img" src="img/fabric-video/01.png" alt="projects-item-img">
                        <div class="project-title">
                            Проект 2 название с длинным текстом и не помещается в 1 строку и даже в 2 строки не помещается
                        </div>
                    </a>
                </div>
