            ...
            <div class="header-bottom">
                <div class="header__container">
                    ...
                    <div class="header-scroll-items" data-da=".menu__mobile,960,2">
                        ...
                        <a href="/services.php" class="header-item active">Услуги</a>
        ...
        <main class="page services-page">
            ...
            <div class="services-page__container">
                ...
                <div class="service-items">
                    <!-- Структура элемента service-item такая:
                        1. тайтл
                        2. иконка
                        3. текст
                        4. доп текст (service-item__suibtitle)
                    ...
                    <div class="service-item">
                        <div class="service-item-texts">
                            <div class="service-item__title">
                                ...
                                <!-- 
                                    тут нужно будет ещё подумать как правильно выводить эту иконку, если у
                                    этого элемента service-item нет фото, то есть как правильно выводить все элементы,
                                    в одном цикле, но с разным отображением в зависимости от наличия или
                                    отсутствия у элемента фотографий
                                -->

                                <div class="service-item__text-icon mob">
                                    <img src="img/services/service-item-1.svg" alt="service-icon">
                                </div>
                            </div>
                            <div class="service-item__text">
                                ...
                                <div class="service-item__text-text">
                                    Наша компания предоставляет послепродажное обслуживание в течение
                                    12 месяцев после поставки изделия, включая ремонт и замену предоставленных
                                    деталей или комплектов оборудования.
                                </div>
                            </div>
                            <div class="service-item__suibtitle">
                                У нас есть команда послепродажного обслуживания и профессиональные техники
                                в Москве для оказания технических услуг.
                            </div>
                        </div>
                        <div class="service-item-images">
                            <div class="service-item-image"></div>
                        </div>
                    </div>
                    ...
                    <div class="service-item">
                        <div class="service-item-texts">
                            ...
                            <div class="service-item__text">
                                ...
                                <div class="service-item__text-text">
                                    В соответствии с требованиями заказчика мы можем обеспечить доставку с
                                    китайских заводов и доставку в любой город России, Белоруссии и Казахстана.
                                </div>
                            </div>
                            <div class="service-item__suibtitle">
                            </div>
                    ...
                    <!-- тут если у элемента есть ещё и фото, то нужно добавить класс service-item-with-images -->
                    <div class="service-item service-item-with-images">
                        <div class="service-item-texts">
                            <div class="service-item__title">
                                <span>Кастомизация продукта</span>
                                <div class="service-item__text-icon">
                                    <img src="img/services/service-item-3.svg" alt="service-icon">
                                </div>
                            </div>
                            <div class="service-item__text">
                                <!-- тут если у элемента есть ещё и фото, то нужно добавить класс hidden -->
                                <div class="service-item__text-icon hidden">
                                    <img src="img/services/service-item-3.svg" alt="service-icon">
                                </div>
                                <div class="service-item__text-text">
                                    Индивидуальное производство и упаковка в соответствии со спецификациями заказчика.
                                </div>
                            </div>
                            <div class="service-item__suibtitle">
                                Отобразите свой логотип в интерфейсе, который запускает операционную систему устройства. Напечатайте свой логотип на устройстве. 
                            </div>
                        </div>
                        <div class="service-item-images">
                            <div class="service-item-image">
                                <img src="img/services/01.png" alt="services-item-img">
                            </div>
                            <div class="service-item-image">
                                <img src="img/services/01.png" alt="services-item-img">
                            </div>
